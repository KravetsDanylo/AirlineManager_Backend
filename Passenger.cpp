...
Passenger::Passenger(std::string name, std::string pass, std::string ph, std::string mail) : name(name), passportNumber(pass), phoneNumber(ph), email(mail) {
	this->id = globalIdCounter++;
}

Passenger::Passenger(int i, std::string n, std::string pass, std::string ph, std::string mail)
    : id(i), name(n), passportNumber(pass), phoneNumber(ph), email(mail) {
